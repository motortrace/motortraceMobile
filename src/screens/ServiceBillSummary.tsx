...
interface ServiceBillSummaryProps {
  serviceType?: string;
  location?: string;
  date?: string;
  time?: string;
...
const ServiceBillSummary: React.FC<ServiceBillSummaryProps> = ({
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.bottomSection}>
          <TouchableOpacity style={styles.continueButton} onPress={onContinue}>
            ...
            <Icon name="arrow-forward" size={20} color={Colors.neutral0} />
          </TouchableOpacity>
        </View>
      </ScrollView>
    </View>
